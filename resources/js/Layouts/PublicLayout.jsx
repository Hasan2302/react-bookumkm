            ...
            >
                <div className="px-6 mx-auto max-w-7xl lg:px-8">
                    <div className="flex items-center justify-between h-12">
                        ...
                        <div className="absolute items-center hidden gap-8 transform -translate-x-1/2 left-1/2 md:flex">
                ...
                {mobileMenuOpen && (
                    <div className="absolute left-0 right-0 px-4 pt-2 pb-6 border-b border-gray-100 shadow-lg bg-white/90 backdrop-blur-2xl md:hidden top-full">
