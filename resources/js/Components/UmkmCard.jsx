                ...
                <div className="relative grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="p-8 md:p-12">
                        ...
                        <button
                            ...
                            className="relative w-full px-8 py-4 overflow-hidden text-lg font-bold text-white transition-all duration-300 group shadow-linear bg-brand-600 rounded-full hover:bg-brand-700 hover:scale-105 hover:shadow-linear-lg"
                        >
        ...
        <div className="relative h-32 overflow-hidden sm:h-40 md:h-48">
            ...
            <div className="absolute top-2 right-2 sm:top-3 sm:right-3 flex items-start gap-1.5 sm:gap-2 z-10">
                ...
                <button
                    ...
                    className="p-2 bg-white/90 backdrop-blur-sm rounded-full shadow-sm hover:bg-white hover:shadow-md transition-all duration-200 active:scale-95 group/btn"
                    title="Lihat Detail"
                >
