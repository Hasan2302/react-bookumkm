        ...
        {umkm && (
            <>
                ...
                <div className="flex justify-end gap-2">
                    ...
                    <button
                        type="button"
                        className="px-6 py-2 text-white rounded bg-red-600 hover:bg-red-700"
                        onClick={onDelete}
                    >
                        Hapus
                    </button>
        ...
        >
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex justify-end gap-2 pt-4">
                    ...
                    <button
                        type="submit"
                        className="px-6 py-2 text-white rounded bg-indigo-600 hover:bg-indigo-700"
                    >
                        Simpan
                    </button>
                </div>
...
const UmkmDetailModal = ({ umkm, isOpen, onClose }) => (
    ...
    >
        ...
        <div className="flex justify-end mt-8">
            <button
                onClick={onClose}
                className="px-6 py-3 text-white transition rounded-lg bg-indigo-600 hover:bg-indigo-700"
            >
                Tutup
            </button>
        </div>
    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-between mb-4">
                ...
                />
                <button
                    className="ml-4 flex items-center gap-1 px-6 py-2 text-white rounded-lg bg-indigo-600 hover:bg-indigo-700 transition"
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {paginatedUmkm.map((umkm) => (
                            ...
                            >
                                ...
                                <td className="px-6 py-4 space-x-3 text-sm flex items-center">
                                    <button
