...
export default function Welcome({ umkms = [], featured = null, canLogin, canRegister }) {
    ...
    const filteredUmkms = useMemo(() => {
        ...
        if (selectedCategory) {
            filtered = filtered.filter(u => u.category?.toLowerCase().includes(selectedCategory));
        }
        ...
        <PublicLayout canLogin={canLogin} canRegister={canRegister}>
                ...
                <div className="relative z-10 px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8 text-center">
                        <div className="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 mb-4 sm:mb-6 space-x-2 rounded-full bg-white/20 backdrop-blur-sm">
                            ...
                            <span className="text-xs sm:text-sm font-semibold text-white">Platform Booking UMKM Terpercaya</span>
                        </div>
                    ...
                    <div className="max-w-4xl p-4 mx-auto shadow-2xl sm:p-6 lg:p-8 bg-white/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full py-3 sm:py-4 lg:py-5 pl-12 sm:pl-14 lg:pl-16 pr-20 sm:pr-24 text-sm sm:text-base lg:text-lg font-medium text-gray-900 placeholder-gray-400 transition-all duration-300 border-2 border-gray-200 rounded-xl sm:rounded-2xl focus:border-primary-500 focus:ring-4 focus:ring-primary-100 focus:outline-none"
                            />
                            <button 
                        ...
                        <div className="hidden gap-4 mt-4 text-xs sm:flex sm:items-center sm:justify-center sm:gap-6 sm:mt-6 sm:text-sm text-gray-600">
                        ...
                        <div className="relative p-[3px] rounded-3xl bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-300 shadow-2xl">
                            ...
                            <div className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-white rounded-3xl">
                                ...
                                <div className="relative z-10 grid items-center gap-8 p-8 md:grid-cols-2 md:p-12">
                                    <div>
                                        {/* Premium Badge */}
                                        <div className="inline-flex items-center px-4 py-2 mb-4 space-x-2 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 shadow-lg">
            ...
            <section className="py-20 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900">
                <div className="px-4 mx-auto text-center max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <Link
                        href="/register"
                        className="inline-flex items-center gap-2 px-10 py-5 text-lg font-bold transition-all duration-300 shadow-2xl text-primary-700 bg-white rounded-2xl hover:scale-105 hover:shadow-3xl"
                    >
