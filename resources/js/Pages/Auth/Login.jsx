                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-8 text-center">
                        <div className="flex items-center justify-center mb-3">
                            <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-brand-500 to-brand-600 rounded-xl">
                    ...
                    <div className="mb-6">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <button
                                type="button"
                                onClick={() => setForm({ ...form, role: 'umkm_admin', email: 'umkm@gmail.com' })}
                            ...
                            <button
                                type="button"
                                onClick={() => setForm({ ...form, role: 'superadmin', email: 'admin@gmail.com' })}
                                className={`p-3 text-center border rounded-lg transition-all ${
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="flex items-center justify-center w-full gap-2 py-3 text-sm font-bold text-white transition-all duration-200 rounded-lg bg-gradient-to-r from-brand-600 to-brand-700 hover:from-brand-700 hover:to-brand-800 disabled:opacity-70"
                        >
                            {loading ? (
                                <>
                    ...
                    <div className={`mt-6 text-center ${form.role === 'superadmin' ? 'hidden' : 'block'}`}>
                        <p className="text-sm text-gray-600">
                            ...
                            <Link to="/register-umkm" className="font-bold text-brand-600 hover:underline">
                                Daftar di sini
                            </Link>
                        </p>
                    </div>
