...
import { Eye, EyeOff, Loader2, Smartphone, Mail, Store, Shield } from 'lucide-react';
...
export default function Login() {
    ...
    return (
        <div className="flex min-h-screen">
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-6">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <button
                                type="button"
                                onClick={() => setForm({ ...form, role: 'umkm_admin' })}
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        {/* Remember Me & Forgot Password - DIKECILKAN */}
                    ...
                    {/* Footer - DIKECILKAN & HIDDEN untuk Super Admin */}
                    <div className={`mt-6 text-center ${form.role === 'superadmin' ? 'hidden' : 'block'}`}>
                        <p className="text-sm text-gray-600">
                            Belum punya akun UMKM?{' '}
                            <Link to="/register-umkm" className="font-bold text-indigo-600 hover:underline">
                                Daftar di sini
                            </Link>
                        </p>
                    </div>
            ...
            {/* Right Side - Hero Image - DIKECILKAN atau HAPUS jika masih scroll */}
